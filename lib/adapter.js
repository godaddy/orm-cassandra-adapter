...
CassandraAdapter.prototype.propertyToValue = function(value, property) {
  return { value: value, hint: property.type };
};

CassandraAdapter.prototype.valueToProperty = function(value) {
  return value;
};
